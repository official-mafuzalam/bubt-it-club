...
class ExpenseCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.accounts.expenses.categories.index', compact('expenseCategories'));
    }
    ...
    {
        return view('admin.accounts.expenses.categories.create');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('admin.accounts.expenses.categories.show', compact('category'));
    }
    ...
    {
        $category = ExpenseCategory::findOrFail($id);
        return view('admin.accounts.expenses.categories.create', compact('category'));
    }
