                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea name="short_description" id="short_description" rows="2" required
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{ old('short_description', $project->short_description) }}</textarea>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                @if ($project->image_url)
                                    <div class="mb-2">
                                        <img src="{{ asset('storage/' . $project->image_url) }}" alt="Project Image"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
                                    @php
                                        $projectTechnologies = json_decode($project->technologies, true) ?? [];
                                    @endphp
                                    ...
                                    @foreach ($technologies as $tech)
                                        <div class="flex items-center">
                                            <input type="checkbox" name="technologies[]"
                                                ...
                                                {{ in_array($tech, old('technologies', $projectTechnologies)) ? 'checked' : '' }}>
