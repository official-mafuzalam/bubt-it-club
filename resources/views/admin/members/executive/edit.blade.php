<x-admin-layout>
    <x-slot name="main">
        @section('page-title')
            <title>Edit Executive Committee | BUBT IT Club</title>
        @endsection
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            <div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                    Update the executive committee details
                </p>
            </div>
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden dark:bg-gray-800">
            <form action="{{ route('admin.executive-committees.update', $executiveCommittee) }}" method="POST">
                @csrf
                @method('PUT')
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="name" id="name" required
                                    ...
                                    value="{{ old('name', $executiveCommittee->name) }}">
                                @error('name')
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="3"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Brief description of this committee">{{ old('description', $executiveCommittee->description) }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="date" name="term_start" id="term_start" required
                                    ...
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    value="{{ old('term_start', $executiveCommittee->term_start->format('Y-m-d')) }}">
                                @error('term_start')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" name="term_end" id="term_end" required
                                    onclick="this.showPicker()"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    value="{{ old('term_end', $executiveCommittee->term_end->format('Y-m-d')) }}">
                                @error('term_end')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                ...
                <!-- Form Footer -->
                <div class="flex items-center justify-between p-6 bg-gray-50 dark:bg-gray-700 space-x-3">
                    <div>
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            Created on: {{ $executiveCommittee->created_at->format('F j, Y') }}
                        </p>
                    </div>
