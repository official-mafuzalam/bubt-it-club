        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            <div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                    Register a new member to BUBT IT Club
                </p>
            </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="student_id" id="student_id" required
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="e.g. 22151010XX" value="{{ old('student_id') }}">
                                @error('student_id')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="bio" id="bio" rows="3"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{ old('bio') }}</textarea>
                            @error('bio')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                                ...
                                @foreach (['facebook', 'twitter', 'linkedin', 'github'] as $social)
                                    <div class="flex items-center">
                                        ...
                                        <input type="url" name="social_links[{{ $social }}]"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="https://" value="{{ old('social_links.' . $social) }}">
                                    </div>
                                @endforeach
                            </div>
                            @error('social_links.*')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="flex items-center">
                                    <div class="flex items-center mr-4">
                                        <input type="checkbox" name="contact_public" id="contact_public"
                                            value="1"
                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                            {{ old('contact_public', 0) == 1 ? 'checked' : '' }}>
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" name="contact_public" id="contact_private"
                                            value="0"
                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                            {{ old('contact_public', 0) == 0 ? 'checked' : '' }}>
                                        <label for="contact_private"
                                            class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                            Private
                                        </label>
                                    </div>
                                </div>
                                @error('contact_public')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center">
                                    <div class="flex items-center mr-4">
                                        <input type="checkbox" name="social_links_public" id="social_links_public"
                                            value="1"
                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                            {{ old('social_links_public', 0) == 1 ? 'checked' : '' }}>
                                        <label for="social_links_public"
                                            class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                            Public
                                        </label>
                                    </div>
                                    <div class="flex items-center">
                                        <input type="checkbox" name="social_links_public" id="social_links_private"
                                            value="0"
                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                            {{ old('social_links_public', 0) == 0 ? 'checked' : '' }}>
                                        <label for="social_links_private"
                                            class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                            Private
                                        </label>
                                    </div>
                                </div>
                                @error('social_links_public')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        </div>
